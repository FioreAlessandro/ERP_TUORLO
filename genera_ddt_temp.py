...
OUTPUT = os.path.join(BASE, "DDT_TEMP")
...
# 🔥 NUOVO: capisce se è modalità temp
modo = sys.argv[2] if len(sys.argv) > 2 else "normale"

# 🔥 SOLO per uso normale filtra "nuovo"
if modo != "temp":
    if "Stato" in ord_cli.columns:
        ord_cli = ord_cli[ord_cli["Stato"] == "nuovo"]
print("TELEFONO:", telefono)
print("ORDINI TROVATI:", len(ord_cli))

if ord_cli.empty:
    print("Nessun ordine per ", telefono)
    sys.exit()
...
# ===== SE NON TROVA PREZZO SPECIALE USA STANDARD =====
    ...
    # ================= OLIO =================
        ...
        descr = "Bottiglie Olio Extravergine d'Oliva 0.5L - Lot 10/2025 -- Scad 06/2027"
